...
const CARD_SCENE_PATH = "res://core/cards/card.tscn"
const CARD_SCALE = Vector2(0.8, 0.8)
const CARD_GRID_SPACE = Vector2(140, 180) 

const HEADER_FONT_PATH = "res://core/fonts/SF-Pro-Display-Black.otf"
const SUBHEADER_FONT_PATH = "res://core/fonts/SF-Pro-Display-Semibold.otf"
