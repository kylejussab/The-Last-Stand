...
var whooshSounds = [
	preload("res://core/audio/ui/whoosh.wav"),
	preload("res://core/audio/ui/whoosh2.wav")
]

var drawSounds = [
	preload("res://core/cards/audio/deal_1.wav"),
	preload("res://core/cards/audio/deal_2.wav"),
	preload("res://core/cards/audio/deal_3.wav"),
	preload("res://core/cards/audio/deal_4.wav"),
	preload("res://core/cards/audio/deal_5.wav"),
	preload("res://core/cards/audio/deal_6.wav"),
	preload("res://core/cards/audio/deal_7.wav")
]

var shuffleSounds = [
	preload("res://core/cards/audio/shuffle_1.wav"),
	preload("res://core/cards/audio/shuffle_2.wav"),
	preload("res://core/cards/audio/shuffle_3.wav"),
	preload("res://core/cards/audio/shuffle_4.wav")
]

var rationCollectionSounds = [
	preload("res://core/audio/ui/rationsCollected.wav"),
	preload("res://core/audio/ui/rationsCollected2.wav"),
	preload("res://core/audio/ui/rationsCollected3.wav"),
	preload("res://core/audio/ui/rationsCollected4.wav")
]

var suspenseBackground = [
	"res://core/audio/music/Suspense/Suspense #2.mp3",
	"res://core/audio/music/Suspense/Shiver.mp3",
	"res://core/audio/music/Suspense/Poluted Horizons.mp3",
	"res://core/audio/music/Suspense/Undercurrent.mp3",
	"res://core/audio/music/Suspense/Suspense #1.mp3",
	"res://core/audio/music/Suspense/Undertone.mp3",
]

var beyondTheThreshold = [
	"res://core/audio/music/The Perilous Path/1 Beyond the Threshold - Layer 1.wav",
	"res://core/audio/music/The Perilous Path/1 Beyond the Threshold - Layer 2.wav"
]

var carvingThePath = [
	"res://core/audio/music/The Perilous Path/2 Carving the Path - Layer 1.wav",
	"res://core/audio/music/The Perilous Path/2 Carving the Path - Layer 2.wav"
]

var quickeningStride = [
	"res://core/audio/music/The Perilous Path/3 Quickening Stride - Layer 1.wav",
	"res://core/audio/music/The Perilous Path/3 Quickening Stride - Layer 2.wav"
]
