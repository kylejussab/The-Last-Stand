...
@onready var textLabel = $"../TooltipDescriptionLabel"

func _ready():
	toggle_mode = true
	focus_mode = Control.FOCUS_NONE
	
	var showingTooltips = AccessibilityData.showCardTooltips
	set_pressed_no_signal(showingTooltips)
...
func _on_toggled(buttonState: bool):
	...
	AccessibilityData.showCardTooltips = buttonState
	...
	if AccessibilityData.showCardTooltips:
		textLabel.text = "On"
	else:
		textLabel.text = "Off"
