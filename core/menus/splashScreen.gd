...
func _ready() -> void:
	...
	ResourceLoader.load_threaded_request("res://core/menus/mainMenu.tscn")
	...
	Curtain.change_scene_to_packed(ResourceLoader.load_threaded_get("res://core/menus/mainMenu.tscn"), 2.0)
