...
func update_preview_card(targetKey: String):
	...
	currentPreviewCard.get_node("imageBack").texture = load("res://assets/cards/CardBackBlank.png")
	
	var faction_path = "res://assets/cardIcons/" + currentPreviewCard.faction + ".png"
